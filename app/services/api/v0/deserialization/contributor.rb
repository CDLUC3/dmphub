...
module Api
  module V0
    module Deserialization
      # Converts incoming JSON version of a Contributor into a Person
      class Contributor
        class << self
          ...
          def deserialize_org(json: {})
            ...
            Api::V0::Deserialization::Org.deserialize!(json: json[:affiliation])
          end
          ...
          def attach_identifier!(contributor:, json: {})
            ...
            Api::V0::Deserialization::Identifier.deserialize!(
