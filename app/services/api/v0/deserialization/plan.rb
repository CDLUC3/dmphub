...
module Api
  module V0
    module Deserialization
      # Convert a JSON represention of a Plan into a Project and Plan
      ...
      class Plan
        class << self
          ...
          def deserialize_project(plan:, json: {})
            ...
            Api::V0::Deserialization::Funding.deserialize!(plan: plan, json: funding)
          end
          ...
          def deserialize_contributors(plan:, json: {})
            contributors = json.fetch(:contributor, []).map do |hash|
              Api::V0::Deserialization::Contributor.deserialize!(
