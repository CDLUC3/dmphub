...
RSpec.describe ExternalApis::BaseService do
  before(:each) do
    ...
    allow(described_class).to receive(:landing_page_url).and_return(Faker::Internet.url)
    allow(described_class).to receive(:api_base_url).and_return(Faker::Internet.url)
  end
  ...
  context 'private methods' do
    ...
    context '#app_email' do
      it 'returns the help_desk email defined in dmproadmap.rb initializer' do
        Rails.configuration.x.application.helpdesk_email = 'Foo'
